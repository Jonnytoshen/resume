...
export const aboutMe = '拥有 10 年前端/全栈开发经验的资深工程师，专注于企业级前端架构、Web GIS 可视化与工程化提效。擅长运用 Monorepo、NestJS 后端工程化实践与自动化测试体系解决复杂业务场景下的协作与交付难题。主导开源 GIS 组件库 [workletjs](https://github.com/workletjs/workletjs)，持续探索现代前端工程最佳实践。期待加入一个重视技术深度与业务价值的团队，共同构建高质量的数字产品。';
