...
- 工作年限：10年
- 电话：(+86) 13241468893
- 邮箱：jonnytoshen@gmail.com
- github: https://github.com/Jonnytoshen

# 关于我

拥有 10 年前端/全栈开发经验的资深工程师，专注于企业级前端架构、Web GIS 可视化与工程化提效。擅长运用 Monorepo、DDD 后端服务设计（NestJS）与自动化测试体系解决复杂业务场景下的协作与交付难题。主导开源 GIS 组件库 [workletjs](https://github.com/workletjs/workletjs)，持续探索现代前端工程最佳实践。期待加入一个重视技术深度与业务价值的团队，共同构建高质量的数字产品。
...
- 时间：2023.07 - 至今
- 职位：前端开发工程师
- 职责：负责公司核心产品的需求分析与全栈开发（前端 + 后端 BFF 层），主导地图相关公共组件的封装与发布，显著提升项目复用性和团队整体开发效率。搭建企业级前端架构，实现多应用、多库的 Monorepo 管理体系。参与项目的部署与运维，确保应用稳定上线与持续交付。负责阿里云ECS服务器的采购，以及产品域名注册、备案及管理工作（DNS解析和TLS证书申请）。

## 中化明达科技有限公司

- 时间：2018.06 - 2023.07
- 职位：前端开发工程师
- 职责：负责公司核心产品的 PC 端及 H5 前端开发与性能优化，并参与课题研究汇报类应用的构建；协助开发互联网数据抓取脚本，支撑业务数据的采集与分析；同时参与软件著作权、高新技术企业资质等申报材料的整理与编制工作，为公司的资质认证与项目申报提供技术支持。

## 北京中盈安信技术服务股份有限公司

- 时间：2016.06 - 2018.05
- 职位：前端开发工程师
- 职责：参与 InSAR 数据平台的前端研发，搭建基于 Gulp 的前端脚手架，有效提升工程化效率；负责“外业调查助手（NativeScript）”项目的开发与迭代维护；参与前端技术选型与经验总结，并为其他团队提供前端技术支持。

# 项目经验

## Workletjs（开源 Angular 地图库）

- 角色：项目发起人 & 核心维护者
- 时间：2025.10 - 至今
- 描述：主导设计并开发了 Workletjs，一个基于 OpenLayers 的 Angular 地图组件库，致力于提供与 OpenLayers 无缝集成的地图解决方案。通过模块化封装与文档化实践，降低地图功能接入与维护成本。
- 项目地址：https://workletjs.github.io/
- 技术栈：Typescript, Angular, OpenLayers, Tailwind CSS, Nx Monorepo, Vitest, GitHub Actions, pnpm
- 核心职责与产出:
...
- 角色：前端开发技术负责人
- 时间 2024.07 - 至今
- 描述：羲和自动报告系统是一套面向新能源发电项目的自动化、辅助编写报告平台，覆盖风电与光伏项目前期分析、指标计算与标准化报告生成流程。通过自动化与模板化，将风电/光伏报告编制效率提升 60%+ ，核心代码复用率 70%+。
- 技术栈：Nx Monorepo, Angular, NgRx, Ant Design for Angular, NestJS, Nest Commander, MongoDB, ECharts
- 核心职责与产出：
...
- 角色：前端开发技术负责人
- 时间：2023.07 - 2025.03
- 描述：“羲和前期评估系统”是一款服务于新能源项目前期开发的全链路评估与辅助决策平台。系统通过整合中尺度气象数据与高分辨率地形数据，实现对风资源分布、发电潜力及收益率的精准量化分析，帮助客户快速判断场址开发价值，提升项目决策效率与科学性。
- 技术栈：Typescript, Angular, Angular Material, NgRx, OpenLayers, ECharts, NestJS, MongoDB, Nx monorepo, Playwright, Docker
- 核心职责与产出：
...
- 角色：前端核心开发人员
- 时间：2021.03 - 2023.02
- 描述：新能源协作平台是一个面向新能源项目（风电、光伏等）开发选址、空间分析和项目管理的综合协作系统，为新能源项目开发提供全流程的数字化支持。
- 技术栈：Angular, Ant Design for Angular, OpenLayers, NestJS, TypeORM, PostgreSQL, Keycloak, Turf.js
- 核心职责与产出：
...
- 角色：前端核心开发人员
- 时间：2020.03 - 2021.05
- 描述：作为项目核心开发者，参与设计并实现了基于Angular的风电项目宏观选址可视化应用。该项目聚焦于风电项目选址成果的可视化展示与交互分析，通过整合二维与三维地图引擎，结合数据可视化技术，实现了高效、直观的宏观选址决策支持平台。
- 技术栈：Angular, TypeScript, OpenLayers, Cesium, ECharts, RxJS, WebGL
- 核心职责与产出：
...
- 角色：前端核心开发人员
- 时间：2018.08 - 2019.06
- 描述：面向新能源项目规划管理的综合可视化服务平台，围绕风电、光伏新能源资源分布、统计分析需求，构建集地图、图表与大屏展示于一体的可视化应用，为区域新能源开发与管理提供数据支撑。
- 技术栈：Angular, TypeScript, RxJS, OpenLayers, ECharts, D3, DeckGL, Webpack
- 核心职责与产出：
...
- 角色：核心开发人员
- 时间：2017.10 - 2018.05
- 描述：针对地质灾害巡检场景开发的 App，旨在解决野外环境下高精度轨迹采集与复杂表单录入的痛点。
- 技术栈：NativeScript, Angular, TypeScript, 高德地图 SDK（原生封装）, 科大讯飞语音转文字 SDK
- 核心职责与产出：
...
- 描述：基于 Angular（Signals）和 OpenLayers 构建的现代地图组件库。
- 项目地址：https://workletjs.github.io/
- 仓库地址：https://github.com/workletjs/

## PR & issues

- 描述：持续参与 OpenLayers、nrwl/nx、antvis 等开源生态，提交过代码与问题反馈。
- 项目地址：https://github.com/pulls?q=author:Jonnytoshen

# 教育背景

学校|专业|时间
----|----|----
成都电子科技大学|计算机应用技术|2012.03 - 2014.06